...
from clients.parse_data_client import IParserDataClient, ParserDataClient
...
from domains.parser_domain import Parser
from repositories.db_discrepancy import DiscrepancyRepository


def get_parser_domain() -> IParserDataClient:
